    ...
    <>
      <div className="fixed inset-x-0 top-3 z-50">
        <div className="container mx-auto px-2 sm:px-4">
          <header
            className={cn(
              'w-full rounded-sm border transition-all duration-300',
              'border-border/80 border-2 bg-background/88 backdrop-blur-sm supports-backdrop-filter:bg-background/90'
            )}
            role="banner"
          >
