  ...
  return (
    <section className="relative border-t border-border/60 bg-linear-to-b from-white via-zinc-50/55 to-white pb-10 pt-8 dark:from-zinc-950 dark:via-zinc-950 dark:to-black lg:pb-14">
      ...
      <div className="container mx-auto space-y-5 px-2 sm:px-4 lg:space-y-6">
        <div className="relative overflow-hidden rounded-sm border border-zinc-900/10 bg-linear-to-br from-zinc-950 via-zinc-900 to-zinc-800 p-5 text-white shadow-xl shadow-zinc-900/20 dark:border-zinc-700/60 dark:from-zinc-900 dark:via-zinc-950 dark:to-black dark:shadow-black/55 sm:p-7">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[minmax(270px,0.2fr)_minmax(0,1fr)] xl:gap-5">
          <aside className="xl:sticky xl:top-20 xl:h-fit">
            <div className="rounded-sm border border-zinc-200/80 bg-card/90 p-4 shadow-xs backdrop-blur supports-backdrop-filter:bg-card/70 dark:border-zinc-700/80 dark:bg-zinc-850/75 dark:shadow-black/30 sm:p-5">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
              {paginatedItems.length > 0 ? (
                ...
                <div className="col-span-full rounded-sm border border-dashed border-zinc-300/70 bg-white/70 py-20 text-center dark:border-zinc-800 dark:bg-zinc-950/65">
